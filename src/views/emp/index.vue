...
const EmpList = ref([]);
  // "https://aliyun-oss-test-zgq.oss-cn-nanjing.aliyuncs.com/20231109115022_58073.jpg"
...
const beforeAvatarUpload = (rawFile) => {
  if (rawFile.type !== 'image/jpeg' && rawFile.type !== 'image/png' && rawFile.type !== 'image/avif') {
  ...
  <div class="container">
    <el-form :inline="true" :model="searchEmp" class="demo-form-inline">
      <el-form-item label="姓名">
        <el-input v-model="searchEmp.name" placeholder="请输员工入姓名" clearable />
      </el-form-item>
   ...
   <div class="container">
    <el-table :data="EmpList" border style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column  label="头像" width="130" >
        <!-- <img src="https://web-framework.oss-cn-hangzhou.aliyuncs.com/2022-09-02-00-27-53B.jpg" /> -->
        <template #default="scope">
      ...
      <el-table-column prop="updateTime" label="最后操作时间" width="205" align="center"/>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-form-item label="姓名"  prop="name">
              <el-input v-model="employee.name" :readonly="false"  placeholder="请输入员工姓名，2-10个字"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            <el-form-item label="性别"  prop="gender">
              <el-select v-model="employee.gender" :disabled="false"  placeholder="请选择性别" style="width: 100%;">
        ...
        <el-row :gutter="10">
          <el-col :span="24">
            <el-form-item label="工作经历">
              <el-button type="success" size="small" @click="adExprItem">+ 添加工作经历</el-button>
            </el-form-item>
          </el-col>
        </el-row>
